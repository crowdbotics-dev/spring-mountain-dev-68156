...
## Project Structure
    ...
    ├── spring_mountain_dev_68156  # Django project configurations
...
1. Clone this repo and `cd spring_mountain_dev_68156`
...
2. Clone this repo and `cd spring_mountain_dev_68156`
